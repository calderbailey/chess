...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_MEDIUM_GREY = SET_BG_COLOR + "238m";
    ...
    public static final String SET_BG_COLOR_BLUE = SET_BG_COLOR + "25m";
    public static final String SET_BG_COLOR_LIGHT_BLUE = SET_BG_COLOR + "32m";
